class DropBoxController{
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyB_34QQEGqghXTIOIi26Irt0VaL48ZXqdM",
    authDomain: "dropbox-clone-2cd5b.firebaseapp.com",
    databaseURL: "https://dropbox-clone-2cd5b-default-rtdb.firebaseio.com",
    projectId: "dropbox-clone-2cd5b",
    storageBucket: "dropbox-clone-2cd5b.appspot.com",
    messagingSenderId: "667264326571",
    appId: "1:667264326571:web:3988caceee36e4991350ee",
    measurementId: "G-1Q6KJT90PS"
  };
  ...
  firebase.initializeApp(firebaseConfig);
    ...
    modalShow(show = true){
        this.snackModalEl.style.display = (show)?'block':'name';
    }
    uploadTask(files){
        let promises =[];
        [...files].forEach(file=>{
